...
const ProcessingStep: React.FC = () => {
  return (
    <div className="bg-white dark:bg-slate-800 rounded-xl shadow-lg p-12 text-center max-w-md w-full mx-auto">
      <div className="relative mb-6">
        <div className="absolute inset-0 bg-indigo-100 dark:bg-indigo-900/30 rounded-full animate-ping opacity-25"></div>
        <div className="relative bg-white dark:bg-slate-800 p-4 rounded-full inline-block">
